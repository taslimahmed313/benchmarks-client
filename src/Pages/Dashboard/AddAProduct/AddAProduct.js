...
const AddAProduct = () => {
      ...
      queryFn: async() =>{
       try {
        const res = await fetch(
          `https://assginment-project-server-taslimahmed313.vercel.app/verifySeller/${user?.email}`
        );
        const data = res.json();
        return data;
       } catch (error) {
      ...
      setLoading(true);
        ...
        .then(imgData => {
            if(imgData.success){
                ...
                fetch("https://assginment-project-server-taslimahmed313.vercel.app/books", {
                  method: "POST",
                  headers: {
    ...
    return (
      <div>
        {loading ? (
          <>
            <DotLoader className="mx-auto mt-10" color="#36d7b7"></DotLoader>;
          </>
        ) : (
          <div>
            ...
            <div className="h-[950px] w-full flex ml-5 mb-10 mt-5">
