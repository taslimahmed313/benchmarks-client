...
const ExtraSection = () => {
    return (
      <div className="grid lg:grid-cols-2 gap-5 items-center bg-gradient-to-r from-sky-100 to-indigo-100 pt-5 shadow-2xl lg:h-[500px] rounded-xl my-10 lg:p-10 p-5">
        <div>
          <img
